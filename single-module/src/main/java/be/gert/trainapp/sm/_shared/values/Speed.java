...
import static be.gert.trainapp.sm._shared.values.Speed.SpeedMeasurement.KPH;
import static be.gert.trainapp.sm._shared.values.Speed.SpeedMeasurement.MPH;
